        ...
        <div style={{ padding: '16px 16px 12px', borderBottom: '1px solid #F1F5F9' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
            <div>
              ...
              <div style={{ fontSize: 11, color: '#94A3B8', marginTop: 2, fontWeight: 500 }}>{leads.length} leads</div>
            </div>
            <button style={{
        ...
        <div style={{ maxWidth: 720 }}>
          ...
          <Card>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 0, marginTop: 8 }}>
              {['Lead', 'Proposal', 'Application', 'Boarding', 'Live'].map((stage, i) => {
                const stages = ['Lead', 'Proposal', 'Application', 'Boarding', 'Live']
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6 }}>
              {['Lead', 'Proposal', 'Application', 'Boarding', 'Live'].map(stage => (
