...
const activityItems = [
  { text: 'Mountain View Deli moved to Boarding stage', time: '2 hours ago', icon: ArrowUpRight },
  { text: 'Residual payment of $3,985 deposited', time: '1 day ago', icon: DollarSign },
  { text: 'New lead submitted: Fresh Bakes Co.', time: '2 days ago', icon: Store },
  { text: 'Sunset Grill application approved', time: '3 days ago', icon: TrendingUp },
  { text: 'Monthly partner report available', time: '5 days ago', icon: Calendar },
]
            ...
            {activityItems.map((item, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  <item.icon size={14} color="#10B981" strokeWidth={2} />
                </div>
