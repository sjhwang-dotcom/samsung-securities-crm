...
const navItems = [
  { to: '/exec', icon: LayoutDashboard, title: '경영진 대시보드' },
]
    ...
    <div className="harlow-shell">
      <nav className="icon-rail">
        ...
        <div className="icon-rail-bottom">
          ...
          <div className="icon-rail-avatar" title="본부장"><span>본</span></div>
        </div>
      </nav>
      ...
      <div className="harlow-main-wrapper">
        <header className="harlow-topbar">
          <div className="topbar-title-area">
            <h1 className="topbar-title">경영진 대시보드</h1>
            <p className="topbar-sub">영업팀 전체 KPI, 세일즈 코칭, 수수료 전사 뷰</p>
          </div>
        ...
        <footer className="harlow-statusbar">
          <span>기관영업본부 · 15명 세일즈 · 300 기관 고객 · 월 16.7억원</span>
        </footer>
      </div>
